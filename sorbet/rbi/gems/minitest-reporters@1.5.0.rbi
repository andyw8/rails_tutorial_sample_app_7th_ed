...
module Minitest
  class << self
    # source://minitest/5.15.0/lib/minitest.rb#160
    def __run(reporter, options); end

    # source://minitest/5.15.0/lib/minitest.rb#84
    def after_run(&block); end

    # source://minitest/5.15.0/lib/minitest.rb#56
    def autorun; end

    # source://minitest/5.15.0/lib/minitest.rb#33
    def backtrace_filter; end

    # source://minitest/5.15.0/lib/minitest.rb#33
    def backtrace_filter=(_arg0); end

    # source://minitest/5.15.0/lib/minitest.rb#1050
    def clock_time; end

    # source://minitest/5.15.0/lib/minitest.rb#45
    def extensions; end

    # source://minitest/5.15.0/lib/minitest.rb#45
    def extensions=(_arg0); end

    # source://minitest/5.15.0/lib/minitest.rb#249
    def filter_backtrace(bt); end

    # source://minitest/5.15.0/lib/minitest.rb#50
    def info_signal; end

    # source://minitest/5.15.0/lib/minitest.rb#50
    def info_signal=(_arg0); end

    # source://minitest/5.15.0/lib/minitest.rb#88
    def init_plugins(options); end

    # source://minitest/5.15.0/lib/minitest.rb#95
    def load_plugins; end

    # source://minitest/5.15.0/lib/minitest.rb#24
    def parallel_executor; end

    # source://minitest/5.15.0/lib/minitest.rb#24
    def parallel_executor=(_arg0); end

    # source://minitest/5.15.0/lib/minitest.rb#173
    def process_args(args = T.unsafe(nil)); end

    # source://minitest/5.15.0/lib/minitest.rb#40
    def reporter; end

    # source://minitest/5.15.0/lib/minitest.rb#40
    def reporter=(_arg0); end

    # source://minitest/5.15.0/lib/minitest.rb#130
    def run(args = T.unsafe(nil)); end

    # source://minitest/5.15.0/lib/minitest.rb#1041
    def run_one_method(klass, method_name); end
  end
end

# source://minitest/5.15.0/lib/minitest.rb#13
...
# source://minitest/5.15.0/lib/minitest.rb#12
