...
module Minitest
  class << self
    ...
    # sub-classes to run.
    #
    # source://minitest//lib/minitest.rb#160
    ...
    #
    # source://minitest//lib/minitest.rb#56
    def autorun; end

    # source://minitest//lib/minitest.rb#33
    ...
    # source://minitest//lib/minitest.rb#249
    def filter_backtrace(bt); end

    # source://minitest//lib/minitest.rb#50
    def info_signal; end

    # source://minitest//lib/minitest.rb#50
    def info_signal=(_arg0); end

    # source://minitest//lib/minitest.rb#88
    def init_plugins(options); end

    # source://minitest//lib/minitest.rb#95
    def load_plugins; end

    # source://minitest//lib/minitest.rb#24
    ...
    #
    # source://minitest//lib/minitest.rb#130
...
class Minitest::Assertion < ::Exception
  ...
  # source://minitest//lib/minitest.rb#907
...
module Minitest::Assertions
  ...
  #
  # source://minitest//lib/minitest/assertions.rb#301
  ...
  #   assert_operator 5, :<=, 4
  #
  # source://minitest//lib/minitest/assertions.rb#311
  ...
  #
  # source://minitest//lib/minitest/assertions.rb#329
  def assert_output(stdout = T.unsafe(nil), stderr = T.unsafe(nil)); end

  # Fails unless +path+ exists.
  #
  # source://minitest//lib/minitest/assertions.rb#353
  ...
  #   str.must_be :empty?
  #
  # source://minitest//lib/minitest/assertions.rb#367
  ...
  #
  # source://minitest//lib/minitest/assertions.rb#425
  def assert_respond_to(obj, meth, msg = T.unsafe(nil)); end

  # Fails unless +exp+ and +act+ are #equal?
  #
  # source://minitest//lib/minitest/assertions.rb#435
  ...
  #
  # source://minitest//lib/minitest/assertions.rb#448
  ...
  #
  # source://minitest//lib/minitest/assertions.rb#464
  ...
  # that.
  #
  # source://minitest//lib/minitest/assertions.rb#514
  def capture_io; end
  ...
  #
  # source://minitest//lib/minitest/assertions.rb#579
  ...
  # Fails with +msg+.
  #
  # source://minitest//lib/minitest/assertions.rb#602
  def flunk(msg = T.unsafe(nil)); end

  # Returns a proc that will output +msg+ along with the default message.
  #
  # source://minitest//lib/minitest/assertions.rb#610
  ...
  #
  # source://minitest//lib/minitest/assertions.rb#628
  def refute(test, msg = T.unsafe(nil)); end

  # Fails if +obj+ is empty.
  #
  # source://minitest//lib/minitest/assertions.rb#636
  ...
  #   str.wont_be :empty?
  #
  # source://minitest//lib/minitest/assertions.rb#751
  def refute_predicate(o1, op, msg = T.unsafe(nil)); end

  # Fails if +obj+ responds to the message +meth+.
  #
  # source://minitest//lib/minitest/assertions.rb#759
  def refute_respond_to(obj, meth, msg = T.unsafe(nil)); end

  # Fails if +exp+ is the same (by object identity) as +act+.
  #
  # source://minitest//lib/minitest/assertions.rb#768
  ...
  # @return [Boolean]
  #
  # source://minitest//lib/minitest/assertions.rb#802
  def skipped?; end
...
#
# source://minitest//lib/minitest.rb#513
...
class Minitest::Runnable
  ...
  #
  # source://minitest//lib/minitest.rb#266
  def assertions; end
  ...
  # @return [Boolean]
  #
  # source://minitest//lib/minitest.rb#435
  def passed?; end
  ...
  # @raise [NotImplementedError]
  #
  # source://minitest//lib/minitest.rb#425
  def run; end
  ...
  # source://minitest//lib/minitest.rb#278
  def time_it; end
...
# source://minitest//lib/minitest.rb#366
...
class Minitest::StatisticsReporter < ::Minitest::Reporter
  ...
  # source://minitest//lib/minitest.rb#729
  def record(result); end
  ...
  #
  # source://minitest//lib/minitest.rb#678
  def results; end
...
class Minitest::SummaryReporter < ::Minitest::StatisticsReporter
  ...
  # :startdoc:
  #
  # source://minitest//lib/minitest.rb#765
  def start; end
